...
class offerPost(models.Model):
    ...
    offer_body=models.TextField(max_length=1000,verbose_name="Body",blank=True,null=False)
    offer_explaination=models.TextField(max_length=2500,verbose_name='description',blank=True,null=False)
    ...
    offer_picture=models.ImageField(verbose_name="Post Image",upload_to='media/offerPost',  null=True)
